  ...
  return (
    ...
    `,
      ...
      <div className="relative z-10">
        ...
        <div className="pt-[100px] md:pt-[150px]">
                ...
                <div className="ml-4 mr-4 xs:ml-6 sm-plus:ml-8 lg:ml-[9rem] xl-x:m-0">
                  ...
                  <div className="relative mb-16">
                      ...
                      <div className="hidden xl-x:flex gap-4 mt-12">
                        ...
                        >
                          <span className="text-[12px] md:text-[14px] font-medium whitespace-nowrap">
                            <a
                              href="https://nadiavespalec.com/titan-tech-homepage/"
                              target="_blank"
                        ...
                        <a
                          href="https://www.figma.com/design/yj4cQAMZUmqemq0xycaFmc/Untitled?node-id=0-1"
                          target="_blank"
                          rel="noopener noreferrer"
                    ...
                    <h2 className="xl-x:text-[20px]">
                      // Project <span className="font-bold">07</span> | Landing
                      Page Recreation
                    </h2>
          ...
          >
            ...
            <p className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white">
              For this project, I was able to execute a precise implementation
              of Titan Technologies' landing page, transforming their Figma
              mockup into a fully functional webpage. I was able to maintain
              strict adherence to design specifications while strategically
              integrating enhanced features to improve user experience.
            </p>
          </div>
          ...
          >
            ...
            <p className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white">
              Through the completion of this project, I learned to deliver
              pixel-perfect implementations while enhancing user experience
              through strategic customizations. I feel I was able to demonstrate
              strong attention to detail and efficient execution while
              maintaining design fidelity under tight deadlines, which is
              something I hadn't experienced prior to completing this project.
            </p>
          </div>
          ...
          >
            ...
            <ul className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white list-disc pl-6">
              <li className="mb-2">
                ...
                to make the page stand out. Predominantly used HTML and CSS to{" "}
                <span className="text-primary font-semibold">
                  recreate the mockup
                </span>{" "}
                that was provided
              ...
              <li className="mb-2">
                Included all aspects of the design that the client requested,
                accurately displaying information and styling to adhere to the
                original design
              </li>
            </ul>
          </div>
        ...
        {/* Highlights Section */}
        <div
          style={{ display: activeSection === "highlights" ? "block" : "none" }}
          className="mx-8  sm-plus:mx-16 md:mx-auto md:max-w-[800px] lg:max-w-[950px]  text-left mt-16"
        >
          <h2 className="font-bold text-[24px] mb-10 md:mx-8 lg:mx-16 xl:text-[30px] md:text-left text-[#222222] dark:text-white">
            Project Highlights
          ...
          <p className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white">
            ...
            ex eum cupiditate rerum quibusdam dolore, necessitatibus fugiat
            placeat debitis, eaque distinctio omnis quisquam quod adipisci alias
            sequi quo nemo?
          </p>
