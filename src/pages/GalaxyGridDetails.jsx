  ...
  return (
    ...
    `,
        ...
        <div className="pt-[100px] md:pt-[150px]">
          <div className="container mx-auto px-4 xl-x:px-0 lg-x:ml-20 xl-x:ml-0 pl-[0.2rem]">
                ...
                <div className="ml-4 mr-4 xs:ml-6 sm-plus:ml-8 lg:ml-[9rem] xl-x:m-0">
                  ...
                  <div className="relative mb-16">
                    <div className="xl-x:flex xl-x:items-center xl-x:justify-start xl-x:gap-4">
                      <h1 className="font-bold uppercase text-[57px] sm-plus:text-[70px] xl-x:text-[90px] pt-[1rem] mb-0 text-[#2b2b2b] md:text-[78px] md:ml-0 lg-plus:text-[98px] dark:text-white text-left md:leading-tight xl-x:whitespace-nowrap">
                      ...
                      <div className="hidden xl-x:flex items-center gap-4 mt-12 flex-shrink-0">
                        ...
                        <a
                          href="https://github.com/nai-ada/galaxy-grid-2"
                          target="_blank"
                          rel="noopener noreferrer"
                    ...
                    <h2 className="xl-x:text-[20px]">
                      // Project <span className="font-bold">04</span> |
                      In-Browser Game
                    </h2>
            ...
            >
              ...
              <h1 className="font-bold uppercase text-[125px] origin-center -rotate-90 text-[#2b2b2b] dark:text-white whitespace-nowrap">
                <span className="text-primary">P</span>roject 04.
              </h1>
            </div>
          </div>
          ...
          >
            ...
            <p className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white">
              Step into an exciting game of intergalactic Tic-Tac-Toe! Choose
          ...
          >
            ...
            <p className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white">
              {" "}
              Throughout the development of this project, I feel I've
              significantly strengthened my JavaScript programming capabilities.
              The process of implementing game logic, managing player turns,
              handling the role selector, and calculating scores has honed my
              problem-solving skills. Creating win conditions and handling
              various game states also pushed me to think more systematically
              and develop cleaner, more efficient code solutions.{" "}
            </p>
          </div>
          ...
          >
            ...
            <ul className="mb-8 xl:text-[16px] md:mx-8 lg:mx-16 text-[#222222] dark:text-white list-disc pl-6">
              <li className="mb-2">
                Practiced using various{" "}
                <span className="font-semibold text-primary">
                  if-else and switch statements
                </span>{" "}
                for conditional styling and rendering, as well as{" "}
                <span className="font-semibold text-primary">
                  event and DOM methods
                </span>{" "}
                and{" "}
                <span className="font-semibold text-primary">
              ...
              <li className="mb-2">
                Elevated the project's complexity through the implementation of
                advanced systems, including a{" "}
                <span className="font-semibold text-primary">
                  dynamic role-selection mechanism
                </span>{" "}
                allowing users to choose between alien and astronaut characters,
                a{" "}
                <span className="font-semibold text-primary">
                ...
                that determines a winner based on score comparisons
              </li>
              <li className="mb-2">
                Ensured project was{" "}
                <span className="font-semibold text-primary">
                ...
                for mobile use despite original being desktop only
              </li>
            </ul>
          </div>
        </div>
      ...
      <FadeIn>
        ...
        <div className="mt-16">
          <WorksCards currentProject="galaxy" />
        </div>
      </FadeIn>
      <FooterWorks />
    </div>
