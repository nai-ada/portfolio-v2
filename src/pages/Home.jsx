    ...
    <div className="flex flex-col md:items-start md:items-center md:items-start">
      <div className="md-2 md:mb-0 md:flex md:justify-between md:w-full md:w-[103%]">
        <div className="flex flex-col md:flex-row md:items-baseline">
          <h1 className="font-bold text-[62px] xs:text-[70px] md:text-[84px] md-x:text-[110px] md-plus:text-[95px] xs:h-20 sm-x:text-[100px] h-17 md:h-28 text-[#2b2b2b] lg:text-[100px] xl:text-[120px] sm-plus:text-[80px] sm-plus:h-24 sm:text-[90px] sm:h-28 lg-plus:text-[160px] dark:text-white">Nadia</h1>
        ...
        <div className="hidden w-28 lg:w-10  lg:flex lg:flex-col space-y-4 lg-plus:space-y-8 lg:mt-8 xl:mt-12 xl:ml-9 md-x:mt-10 lg:ml-7 lg-plus:mt-[4.4rem] lg-plus:ml-10 lg:self-start dark:invert">
