...
function Connect() {
  ...
  return (
    <>
      <div
        className="md-x:mx-[4rem] lg-plus:mx-[10rem] xl-x:mx-[10rem] mt-48 lg-plus:mt-72 z-100"
        id="connect"
      >
        ...
        <div className="contact-section md:mt-10 md:mb-38 md:mt-18 full:ml-8 4xl:ml-[10rem]">
          <FadeIn>
            ...
            <p className="font-normal text-[16px] p-8 pr-12 md:mr-2 md:ml-6 mt-4 text-[#2b2b2b] lg-x:text-[16px] lg-plus:w-[85%] dark:text-white 4xl:text-[22px]">
              Wanting to see your vision come to life? Whether you have a
              project in mind or just want to chat, I would love to hear from
              you. Feel free to reach out through email, or view my links below!
            </p>
          </FadeIn>
          ...
          <FadeIn>
            <div className="text-center mt-10">
              ...
              />
              <h2 className="inline-block ml-2 text-[14px] font-bold md:text-[18px]">
          ...
          <FadeIn>
            <div className="grid grid-cols-3 border border-black mt-12 md:mt-20 mb-20 md:mb-53 mx-1 xs:mx-4 sm-plus:mx-16 md-x:mx-auto md-x:max-w-[800px] rounded-full overflow-hidden md:ml-30 md:mr-30 dark:border-white">
              <a
                ...
                className="flex items-center justify-center p-10 md:p-14 hover:bg-gray-100 dark:hover:bg-[#0000002f] transition duration-300 border-r border-black -my-4 dark:border-white"
              >
                <img
                  src={LinkedIn}
                  alt="LinkedIn Logo"
                  className="w-5 h-5 mr-1 dark:invert"
                />
                <span className="text-[12px] font-medium md:text-[16px]">
                  LinkedIn
                </span>
                <img
                  src={Arrow}
                  alt="Arrow"
                  className="w-2 h-2 ml-1 dark:invert"
                />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-6 hover:bg-gray-100 dark:hover:bg-[#0000002f] transition duration-300 border-r border-black -my-4 dark:border-white"
              >
                <img
                  src={GitHub}
                  alt="GitHub Logo"
              ...
              <div className="flex items-center justify-center p-2 -my-4">
                <CopyToClipboard text={value} onCopy={() => setCopy(true)}>
                  <Button
                    className={`max-w-[210px] h-[38px] md:h-[48px] flex items-center justify-center rounded-[1000px] bg-primary text-white px-4 md:px-6 ${
                      copy ? "bg-[#757678]" : ""
                    }`}
                  >
