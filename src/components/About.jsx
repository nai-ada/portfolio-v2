    ...
    <div className="absolute left-1/2 top-[185%] -translate-x-1/2 flex flex-col items-center">
      ...
      <div className="w-[6px] h-[6px] bg-primary rounded-full mt-2 md:right-[-4px]"></div>
        ...
        <FadeIn>
          ...
          <p className="font-normal text-[16px] p-8 pr-12 md:mr-2 md:ml-6 pt-2 text-[#2b2b2b] lg-x:text-[18px] lg-plus:w-[78%] dark:text-white">
          ...
          <p className="font-normal text-[16px] p-8 pr-12 pt-0 pb-20 md:mr-2 md:ml-6 text-[#2b2b2b] lg-x:text-[18px] lg-plus:w-[78%] dark:text-white">
