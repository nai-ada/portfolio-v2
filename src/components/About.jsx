        ...
        <div className="md-x:mx-[4rem] lg-plus:mx-[10rem] xl-x:mx-[10rem] full:ml-[12rem] 4xl:ml-[20rem]">
          ...
          <FadeIn>
            ...
            <p className="font-normal text-[16px] p-8 pb-4 pr-12 md:mr-2 md:ml-6 pt-2 text-[#2b2b2b] lg-x:text-[16px] lg-plus:w-[78%] dark:text-white 4xl:text-[22px]">
              ...
              interfaces. Not only does a good application look good, but also{" "}
            ...
            <p className="font-normal text-[16px] p-8 pr-12 pt-0 pb-4 md:mr-2 md:ml-6 text-[#2b2b2b] lg-x:text-[16px] lg-plus:w-[78%] dark:text-white 4xl:text-[22px]">
              ...
              expand my skills, and I actively seek out new technologies and
              methodologies that push me beyond my comfort zone.
            </p>
            <p className="font-normal text-[16px] p-8 pr-12 pt-0 pb-20 md:mr-2 md:ml-6 text-[#2b2b2b] lg-x:text-[16px] lg-plus:w-[78%] dark:text-white 4xl:text-[22px]">
              Aside from coding, I spend my free time playing video games,
              thinking about the universe, and spending time with my cat, Benny.
              I currently work in social media marketing, which fulfills my
              creativity and allows me to meet and collaborate with so many
