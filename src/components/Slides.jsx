        ...
        <div className="mt-10">
          ...
          <Slider ref={sliderRef} {...settings}>
            {projectData.map((d, index) => (
              <div
                key={index}
                className="h-[400px] bg-white dark:bg-gradient-to-b dark:from-[#1d253a] dark:to-darkBackground dark:border-[#414141] border-1 rounded-xl flex flex-col m-2 shadow-[0_4px_7px_rgba(0,0,0,0.1)] dark:shadow-[0_6px_9px_rgba(0,0,0,0.1)]"
              >
                ...
                <div className="flex flex-col flex-grow justify-between p-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-center text-[12px] md:text-[14px] line-clamp-3">
                      {d.info}
                    </p>
                  </div>
